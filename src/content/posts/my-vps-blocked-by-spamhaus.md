...
故事開始是我跟某個~~國家級~~好駭客分著用一台 VPS，本來一直都用得好好的，某天他突然說 `我有個好玩的`，然後就收到我的 VPS 被判斷為 BOTNET ban 掉的信件了。

見鬼，我用 VPS 當 Proxy 掃這麼多東西都沒出事，怎麼會這樣。  
這還是我第一次遇到這種事情，我看到信件後稍微查了一下，好像比較多是使用 SMTP 遇到的問題，只能直接依照他們信件內的指引操作了。
